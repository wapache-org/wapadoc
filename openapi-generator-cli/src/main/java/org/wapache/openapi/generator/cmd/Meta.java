...
package org.wapache.openapi.generator.cmd;
...
import org.wapache.openapi.generator.TemplateManager;
...
public class Meta extends OpenApiGeneratorCommand {
    ...
    @Option(name = {"-p", "--package"}, title = "package",
            description = "the package to put the main class into (defaults to org.wapache.openapi.generator)")
    private String targetPackage = "org.wapache.openapi";
