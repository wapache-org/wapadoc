...
public class HelloController {
	...
	public String persons(@ApiRequestBody(description = "requestBody description as parameter") String name) {
		return "OK";
	}

	@ApiRequestBody(description = "requestBody description outside")
	@PostMapping(value = "/persons2")
	public String persons2(String name) {
		return "OK";
	}

	@Operation(requestBody = @ApiRequestBody(description = "requestBody inside operation annotation"))
