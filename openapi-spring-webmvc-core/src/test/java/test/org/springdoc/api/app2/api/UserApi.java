...
public interface UserApi {
	...
	default ResponseEntity<Void> createUser(
			@ApiRequestBody(description = "Created user object", required = true) @Valid @RequestBody User user) {
	...
	default ResponseEntity<Void> createUsersWithArrayInput(
			@ApiRequestBody(description = "List of user object", required = true) @Valid @RequestBody List<User> user) {
	...
	default ResponseEntity<Void> deleteUser(
			@ApiRequestBody(description = "The name that needs to be deleted", required = true) @PathVariable("username") String username) {
	...
	default ResponseEntity<Void> updateUser(
			...
			@ApiRequestBody(description = "Updated user object", required = true) @Valid @RequestBody User user) {
