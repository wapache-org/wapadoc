...
import org.wapache.openapi.spring.core.PropertyResolverUtils;
...
import org.wapache.openapi.spring.core.ReturnTypeParser;
...
import org.wapache.openapi.spring.core.customizers.ActuatorOpenApiCustomiser;
import org.wapache.openapi.spring.core.customizers.ActuatorOperationCustomizer;
...
import org.wapache.openapi.spring.webmvc.api.WebMvcActuatorProvider;
...
import static org.wapache.openapi.spring.core.Constants.SPRINGDOC_SHOW_ACTUATOR;
...
public class SpringDocWebMvcConfiguration {
	...
	@Lazy(false)
	OpenApiResource openApiResource(ObjectFactory<OpenAPIBuilder> openAPIBuilderObjectFactory,
	...
	@Bean
	@ConditionalOnMissingBean
	RequestBuilder requestBuilder(GenericParameterBuilder parameterBuilder,
	...
	@Bean
	@ConditionalOnMissingBean
	GenericResponseBuilder responseBuilder(OperationBuilder operationBuilder,
