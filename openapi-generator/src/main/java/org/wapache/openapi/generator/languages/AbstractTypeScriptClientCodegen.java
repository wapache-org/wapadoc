...
public abstract class AbstractTypeScriptClientCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    public void setModelPropertyNaming(String naming) {
        try {
            modelPropertyNaming = CodegenConstants.MODEL_PROPERTY_NAMING_TYPE.valueOf(naming);
        } catch (IllegalArgumentException e) {
            String values = Stream.of(CodegenConstants.MODEL_PROPERTY_NAMING_TYPE.values())
    ...
    protected void setEnumPropertyNaming(String naming) {
        try {
            enumPropertyNaming = CodegenConstants.ENUM_PROPERTY_NAMING_TYPE.valueOf(naming);
        } catch (IllegalArgumentException e) {
            String values = Stream.of(CodegenConstants.ENUM_PROPERTY_NAMING_TYPE.values())
                    .map(value -> "'" + value.name() + "'")
                    .collect(Collectors.joining(", "));
