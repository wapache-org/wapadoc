...
import org.wapache.openapi.generator.languages.features.BeanValidationFeatures;
import org.wapache.openapi.generator.languages.features.OptionalFeatures;
import org.wapache.openapi.generator.languages.features.PerformBeanValidationFeatures;
import org.wapache.openapi.generator.meta.features.*;
import org.wapache.openapi.generator.templating.mustache.SplitStringLambda;
import org.wapache.openapi.generator.templating.mustache.TrimWhitespaceLambda;
...
import static org.wapache.openapi.generator.utils.StringUtils.camelize;
...
public class SpringCodegen extends AbstractJavaCodegen
    ...
    protected String configPackage = "org.wapache.openapi.configuration";
    protected String basePackage = "org.wapache.openapi";
    ...
    public SpringCodegen() {
        ...
        apiPackage = "org.wapache.openapi.api";
        modelPackage = "org.wapache.openapi.model";
        invokerPackage = "org.wapache.openapi.api";
    ...
    public void processOpts() {
        ...
        if (!this.interfaceOnly) {
            if (library.equals(SPRING_BOOT)) {
                supportingFiles.add(new SupportingFile("openapi2SpringBoot.mustache",
                        (sourceFolder + File.separator + basePackage).replace(".", File.separator), "OpenAPI2SpringBoot.java"));
            ...
            if (library.equals(SPRING_MVC_LIBRARY)) {
                ...
                supportingFiles.add(new SupportingFile("openapiUiConfiguration.mustache",
                        (sourceFolder + File.separator + configPackage).replace(".", File.separator), "OpenAPIUiConfiguration.java"));
                supportingFiles.add(new SupportingFile("RFC3339DateFormat.mustache",
            ...
            if (library.equals(SPRING_CLOUD_LIBRARY)) {
                ...
                if (!this.reactive && !this.apiFirst) {
                    ...
                    supportingFiles.add(new SupportingFile("openapi.mustache",
                            ("src/main/resources").replace("/", File.separator), "openapi.yaml"));
                }
            }
        ...
        if (!SPRING_CLOUD_LIBRARY.equals(library)) {
            supportingFiles.add(new SupportingFile("apiUtil.mustache",
                    (sourceFolder + File.separator + apiPackage).replace(".", File.separator), "ApiUtil.java"));
        }
