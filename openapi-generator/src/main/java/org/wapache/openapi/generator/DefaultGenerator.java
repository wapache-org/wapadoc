...
package org.wapache.openapi.generator;
...
import org.wapache.openapi.v3.models.security.*;
import org.wapache.openapi.v3.models.tags.Tag;
import org.apache.commons.io.FilenameUtils;
import org.apache.commons.io.comparator.PathFileComparator;
import org.apache.commons.lang3.ObjectUtils;
import org.apache.commons.lang3.StringUtils;
import org.wapache.openapi.generator.api.TemplateDefinition;
import org.wapache.openapi.generator.api.TemplatePathLocator;
import org.wapache.openapi.generator.api.TemplateProcessor;
import org.wapache.openapi.generator.config.GlobalSettings;
import org.wapache.openapi.generator.api.TemplatingEngineAdapter;
import org.wapache.openapi.generator.api.TemplateFileType;
import org.wapache.openapi.generator.ignore.CodegenIgnoreProcessor;
import org.wapache.openapi.generator.languages.PythonClientExperimentalCodegen;
import org.wapache.openapi.generator.meta.GeneratorMetadata;
import org.wapache.openapi.generator.meta.Stability;
import org.wapache.openapi.generator.serializer.SerializerUtils;
import org.wapache.openapi.generator.templating.CommonTemplateContentLocator;
import org.wapache.openapi.generator.templating.GeneratorTemplateContentLocator;
import org.wapache.openapi.generator.templating.MustacheEngineAdapter;
import org.wapache.openapi.generator.templating.TemplateManagerOptions;
import org.wapache.openapi.generator.utils.ImplementationVersion;
import org.wapache.openapi.generator.utils.ModelUtils;
import org.wapache.openapi.generator.utils.ProcessUtils;
import org.wapache.openapi.generator.utils.URLPathUtils;
...
import static org.wapache.openapi.generator.utils.OnceLogger.once;
...
public class DefaultGenerator implements Generator {
    ...
    private void generateApis(List<File> files, List<Object> allOperations, List<Object> allModels) {
        ...
        if(!paths.containsKey("All")){
            generateAllOperationsApi(files, allModels, paths);
        }
    ...
    private void generateAllOperationsApi(List<File> files, List<Object> allModels, Map<String, List<CodegenOperation>> paths) {
        // all operations in one api file
        String tag = "All";

        try {
            List<CodegenOperation> ops = paths.entrySet().stream()
                    .flatMap(m->m.getValue().stream())
                    .distinct()
                    .sorted((one, another) -> ObjectUtils.compare(one.operationId, another.operationId))
            ...
            boolean sortParamsByRequiredFlag = true;
            if (this.config.additionalProperties().containsKey(CodegenConstants.SORT_PARAMS_BY_REQUIRED_FLAG)) {
                sortParamsByRequiredFlag = Boolean.parseBoolean(
                        this.config.additionalProperties().get(CodegenConstants.SORT_PARAMS_BY_REQUIRED_FLAG).toString());
            }
            operation.put("sortParamsByRequiredFlag", sortParamsByRequiredFlag);
