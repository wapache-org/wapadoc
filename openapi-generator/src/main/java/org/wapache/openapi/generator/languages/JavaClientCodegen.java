...
import org.wapache.openapi.generator.meta.features.DocumentationFeature;
import org.wapache.openapi.generator.meta.features.GlobalFeature;
import org.wapache.openapi.generator.templating.mustache.CaseFormatLambda;
...
import org.wapache.openapi.generator.languages.features.GzipFeatures;
...
public class JavaClientCodegen extends AbstractJavaCodegen
    ...
    public JavaClientCodegen() {
        ...
        invokerPackage = "org.wapache.openapi.client";
        artifactId = "openapi-java-client";
        apiPackage = "org.wapache.openapi.client.api";
        modelPackage = "org.wapache.openapi.client.model";
...
//        }
    ...
    static List<Map<String, String>> prioritizeContentTypes(List<Map<String, String>> consumes) {
        ...
        for (Map<String, String> consume : consumes) {
            if (DefaultCodegen.isJsonVendorMimeType(consume.get(MEDIA_TYPE))) {
                jsonVendorMimeTypes.add(consume);
            } else if (DefaultCodegen.isJsonMimeType(consume.get(MEDIA_TYPE))) {
            ...
            for (Object _mo : models) {
                ...
                if (addImports) {
                    Map<String, String> imports2Classnames = new HashMap<String, String>() {{
                        put("JsonNullable", "org.wapache.openapi.generator.jackson.nullable.JsonNullable");
