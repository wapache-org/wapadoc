...
import { endpointBodyTemplate } from '@/templates/endpoint-template';
  ...
  return html`
    ${itemToFocus === 'overview' || itemToFocus === 'authentication' || itemToFocus === 'api-servers'
      ...
      : itemToFocus.startsWith('tag--')
        ...
        : html`
          <div class='regular-font section-gap--focused-mode'>
            ${this.endpointBodyLayout === 'row' ? expandedEndpointBodyTemplate.call(this, selectedPathObj) : endpointBodyTemplate.call(this, selectedPathObj)}
          </div>
        `
    }
  `;
