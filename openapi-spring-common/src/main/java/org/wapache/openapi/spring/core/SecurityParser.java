...
import org.wapache.openapi.v3.annotations.security.SecurityRequirements;
...
public class SecurityParser {
	 ...
	 * @return the boolean
	 */
	private static boolean isEmpty(org.wapache.openapi.v3.annotations.security.OAuthFlows oAuthFlows) {
		boolean result;
		if (oAuthFlows == null)
			result = true;
	 ...
	 * @return the boolean
	 */
	private static boolean isEmpty(org.wapache.openapi.v3.annotations.security.OAuthFlow oAuthFlow) {
		boolean result;
		if (oAuthFlow == null)
			result = true;
	 ...
	 */
	public org.wapache.openapi.v3.annotations.security.SecurityRequirement[] getSecurityRequirements(
			HandlerMethod handlerMethod) {
		// class SecurityRequirements
		Class<?> beanType = handlerMethod.getBeanType();
		Set<org.wapache.openapi.v3.annotations.security.SecurityRequirement>	allSecurityTags = getSecurityRequirementsForClass(beanType);

		// handlerMethod SecurityRequirements
		Method method = handlerMethod.getMethod();
		allSecurityTags = getSecurityRequirementsForMethod(method,allSecurityTags);

		return (allSecurityTags != null) ? allSecurityTags.toArray(new org.wapache.openapi.v3.annotations.security.SecurityRequirement[0]) : null;
	}

	private Set<org.wapache.openapi.v3.annotations.security.SecurityRequirement> getSecurityRequirementsForMethod(Method method, Set<org.wapache.openapi.v3.annotations.security.SecurityRequirement> allSecurityTags) {
		...
		if (CollectionUtils.isEmpty(allSecurityTags)) {
			...
			Set<org.wapache.openapi.v3.annotations.security.SecurityRequirement> securityRequirementsMethodList = AnnotatedElementUtils.findMergedRepeatableAnnotations(method,
					org.wapache.openapi.v3.annotations.security.SecurityRequirement.class);
	...
	public Set<org.wapache.openapi.v3.annotations.security.SecurityRequirement> getSecurityRequirementsForClass(Class<?> beanType) {
		Set<org.wapache.openapi.v3.annotations.security.SecurityRequirement> allSecurityTags =null;
		...
		if (CollectionUtils.isEmpty(allSecurityTags)) {
			...
			Set<org.wapache.openapi.v3.annotations.security.SecurityRequirement> securityRequirementsClassList = AnnotatedElementUtils.findMergedRepeatableAnnotations(
					beanType,
					org.wapache.openapi.v3.annotations.security.SecurityRequirement.class);
	 ...
	 * @return the set
	 */
	private Set<org.wapache.openapi.v3.annotations.security.SecurityRequirement> addSecurityRequirements(Set<org.wapache.openapi.v3.annotations.security.SecurityRequirement> allSecurityTags, Set<org.wapache.openapi.v3.annotations.security.SecurityRequirement> securityRequirementsClassList) {
	...
	public Optional<List<SecurityRequirement>> getSecurityRequirements(
			org.wapache.openapi.v3.annotations.security.SecurityRequirement[] securityRequirementsApi) {
		if (securityRequirementsApi == null || securityRequirementsApi.length == 0)
			return Optional.empty();
		List<SecurityRequirement> securityRequirements = new ArrayList<>();
		for (org.wapache.openapi.v3.annotations.security.SecurityRequirement securityRequirementApi : securityRequirementsApi) {
	...
	public Optional<SecuritySchemePair> getSecurityScheme(
			org.wapache.openapi.v3.annotations.security.SecurityScheme securityScheme) {
	...
	public void buildSecurityRequirement(
            org.wapache.openapi.v3.annotations.security.SecurityRequirement[] securityRequirements, Operation operation) {
	 ...
	 */
	private Optional<OAuthFlows> getOAuthFlows(org.wapache.openapi.v3.annotations.security.OAuthFlows oAuthFlows) {
	 ...
	 */
	private Optional<OAuthFlow> getOAuthFlow(org.wapache.openapi.v3.annotations.security.OAuthFlow oAuthFlow) {
